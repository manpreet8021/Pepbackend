...
const OrderSubmittedInfo = () => {
  const booking = useSelector(state => state.payment)
  const bookingResponse = booking.data
          ...
          <div className="order-completed-wrapper">
            <div className="d-flex flex-column items-center mt-40 lg:md-40 sm:mt-24">
              <div className="size-80 flex-center rounded-full bg-dark-3">
                <i className={`${bookingResponse.booking.status === 'success' ? 'icon-check': 'icon-close'} text-30 text-white`} />
              </div>
              <div className="text-30 lh-1 fw-600 mt-20">
                {bookingResponse.booking.status === 'success'? `${bookingResponse.user.displayName}, your booking was submitted successfully!` : `${bookingResponse.user.displayName}, your booking was failed to submit!`}
              </div>
              ...
              <div className="row">
                <div className="col-lg-4 col-md-6">
                  ...
                  <div className="text-15 lh-12 fw-500 text-blue-1 mt-10">
                    {bookingResponse.booking.bookingNumber}
                  </div>
                </div>
                {/* End .col */}
                <div className="col-lg-4 col-md-6">
                  ...
                  <div className="text-15 lh-12 fw-500 text-blue-1 mt-10">
                    <span>&#8377;</span>{bookingResponse.booking.price}
                  </div>
                </div>
                {/* End .col */}
                <div className="col-lg-4 col-md-6">
                  ...
                  <div className="text-15 lh-12 fw-500 text-blue-1 mt-10">
                    {bookingResponse.booking.method}
                  </div>
                </div>
                {/* End .col */}
              </div>
              ...
              <div className="row y-gap-10">
                <div className="col-12">
                  <div className="d-flex justify-between ">
                    ...
                    <div className="text-15 lh-16 fw-500 text-blue-1">{bookingResponse.user.displayName}</div>
                  </div>
                </div>
                {/* End .col */}
                <div className="col-12">
                ...
                <div className="col-12">
                  <div className="d-flex justify-between border-top-light pt-10">
                    ...
                    <div className="text-15 lh-16 fw-500 text-blue-1">
                      {bookingResponse.user.phoneNumber}
                    </div>
                  </div>
                </div>
                {/* End .col */}
                <div className="col-12">
                  <div className="d-flex justify-between border-top-light pt-10">
                    ...
                    <div className="text-15 lh-16 fw-500 text-blue-1">
                      {bookingResponse.user.address.line1}
                    </div>
                  </div>
                </div>
                {/* End .col */}
                <div className="col-12">
                  <div className="d-flex justify-between border-top-light pt-10">
                    ...
                    <div className="text-15 lh-16 fw-500 text-blue-1">
                      {bookingResponse.user.address.line2}
                    </div>
                  </div>
                </div>
                {/* End .col */}
                <div className="col-12">
                  <div className="d-flex justify-between border-top-light pt-10">
                    ...
                    <div className="text-15 lh-16 fw-500 text-blue-1">
                      {bookingResponse.user.address.state}
                    </div>
                  </div>
                </div>
                {/* End .col */}
                <div className="col-12">
                  <div className="d-flex justify-between border-top-light pt-10">
                    ...
                    <div className="text-15 lh-16 fw-500 text-blue-1">
                      {bookingResponse.user.address.country}
                    </div>
                  </div>
                </div>
                {/* End .col */}
