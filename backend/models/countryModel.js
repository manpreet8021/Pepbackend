...
export const getAllCountries = () => countryModel.find().select('_id name active logo.location logo.id');
...
export const getCountriesByParams = (value) => countryModel.find(value).select('_id name');